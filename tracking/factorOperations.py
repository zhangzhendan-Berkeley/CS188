...
def joinFactors(factors: List[Factor]):
    ...
    for f in factors:
        unconditionedVars |= set(f.unconditionedVariables())
        conditionedVars |= set(f.conditionedVariables())

    conditionedVars -= unconditionedVars
    # === Step 2. Create new factor ===
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        # === Step 1. Define new variable sets ===
        ...
        # === Step 3. Sum out the elimination variable ===
